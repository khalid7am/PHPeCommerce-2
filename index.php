		...
		<div class="container">
			<div class="row justify-content-center mb-3 pb-3">
				<div class="col-md-12 heading-section text-center ftco-animate">
					...
					<p>Découvrez les dernières tendances ici, dès maintenant, avec nous.</p>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-1.jpg"> <span class="status">30%</span>
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-2.jpg">
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-3.jpg">
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-4.jpg">
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
	...
	<section class="ftco-section bg-light">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-5.jpg"> <span class="status">30%</span>
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-6.jpg">
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-7.jpg">
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a class="img-prod" href="#"><img alt="Colorlib Template" class="img-fluid" src="images/product-8.jpg">
						<div class="overlay"></div></a>
						<div class="text py-3 px-3">
							<h3><a href="#">Floral Jackquard Pullover</a></h3>
							<div class="d-flex">
